          ...
          const variantsQueries = hits.map((hit) => {
            ...
            return {
              ...
              params: {
                ...
                // Do not process any facet
                facets: [],
                analyticsTags: ['variants-search'],
                hitsPerPage: 1000,
                attributesToHighlight: [],
                // Only get the attributes needed to render variantes
                attributesToRetrieve: ['boxCondition', 'colorCodeMap', 'currPrice']
              }
            }
          });

          // Only capture variants in client side
          if (typeof window !== 'undefined') {
