...
export const routerOptions = {
  ...
  parseURL({ qsModule, location }) {
    ...
    // Test for brand
    if (!routeState[searchConfig.recordsIndex]) {
      routeState[searchConfig.recordsIndex] = {};
    }
    if (searchParams.has('brand_')) {
      if(routeState[searchConfig.recordsIndex].refinementList) {
        routeState[searchConfig.recordsIndex].refinementList["attributes.Brand"] = [searchParams.get('brand_')];
      } else {
        routeState[searchConfig.recordsIndex]['refinementList'] = {
          "attributes.Brand": [searchParams.get('brand_')]
        };
      }
    }
