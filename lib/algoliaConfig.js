  ...
  parseURL({ qsModule, location }) {
    ...
    if (searchParams.has('brand_')) {
      ...
      if (!routeState[searchConfig.recordsIndex]) {
        ...
        routeState[searchConfig.recordsIndex]['refinementList'] = { ...routeState[searchConfig.recordsIndex]['refinementList'], "attributes.Brand": [searchParams.get('brand_')] }
      }
      searchParams.delete('brand_');
      delete routeState['brand_'];
    }
